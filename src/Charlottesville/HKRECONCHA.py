...
queens = ['GQQ','GTT','STB','DCGQQ','ASJQQ','DGQQ','AGQQ']
suitesK = ['SGK','STE1']
SuitesS = 'STE2'
suitesQ = ['SGQQ','ASGQQ']
# headerRow = ['B1','C1','D1','E1']
headerValues = ['Suite Checkout','Suite Stayover','King Stayover','King Checkout','Queen Stayover','Queen Checkout']
...
def initDict():
    ...
    return {'Suite Checkout':0,'Suite Stayover':0,'King Checkout':0,'King Stayover':0,'Queen Checkout':0,'Queen Stayover':0}
